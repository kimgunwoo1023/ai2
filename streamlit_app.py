...
# Google Drive 파일 ID
file_id = '1UcgSPkDW9cLiSr4r2Fna8jCzArWljcQn'
...
def display_right_content(labels):
    ...
    for i, label in enumerate(labels[:3]):
        with cols[i]:
            st.image(f"https://i.ibb.co/Lr4btyd/dd.jpg?text={label}", caption=f"이미지: {label}", use_column_width=True)
